...
const hiddenCodes = hiddenCode.split("");
const realHiddenCodes = [];
for (let i = 0; i < hiddenCodes.length - 1; i++) {
	if (hiddenCodes[i] !== "X" && hiddenCodes[i] % 2 !== 0) {
		realHiddenCodes.push(hiddenCodes[i]);
	}
}

console.log(realHiddenCodes.join(" "));
